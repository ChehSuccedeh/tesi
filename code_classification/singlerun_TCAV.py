...
def load_dataset(name):
    with open(f"./data/code_classification/{name}.jsonl", "r") as f:
...
CONCEPT_TO_DATASET = {
    "comments": MAIN_DATASETS["comments"],
    "function_declarations": MAIN_DATASETS["functions"],
    "go_function_declarations": MAIN_DATASETS["go_functions"],
    "java_function_declarations": MAIN_DATASETS["java_functions"],
    "javascript_function_declarations": MAIN_DATASETS["javascript_functions"],
    "php_function_declarations": MAIN_DATASETS["php_functions"],
    "python_function_declarations": MAIN_DATASETS["python_functions"],
    "ruby_function_declarations": MAIN_DATASETS["ruby_functions"]
}
...
f_auto.write("Run " + str(run) + "\n" + json.dumps(tcav_auto.get_sensitivity_results(INV_CLASSES), indent=4))
f_fixed.write("Run " + str(run) + "\n" + json.dumps(tcav_fixed.get_sensitivity_results(INV_CLASSES), indent=4))
f_avg.write("Run " + str(run) + "\n" + json.dumps(tcav_avg.get_sensitivity_results(INV_CLASSES), indent=4))
